 ...
 <form action="O_UpdateServlet" id="updateOrderForm" class="order-form" method="post">
                        ...
                        <input type="text" id="orderId" name="OrderID" value="<%=OrderID%>"  readonly>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" id="Date" name="Date" value="<%=OrderID%>"required>
                                </div>
                            </div>
                            
                            <div class="form-group">
                                <label for="orderDetails">Order Details</label>
                                <textarea id="Details" name="Details" rows="4" value="<%=OrderID%>" required></textarea>
                            </div>
                            
                            <div class="form-row">
                                <div class="form-group">
                                    <label for="orderCost">Cost</label>
                                    <input type="number" id="Cost" name="Cost" step="0.01" value="<%=OrderID%>" required>
                                </div>
                                <div class="form-group">
                                    <label for="orderStatus">Status</label>
                                    <select id="Status" name="Status" value="<%=OrderID%>" required>
